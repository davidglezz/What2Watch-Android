...
import com.example.user.testiguandroid.WhatToWatchListView.WTWListFragment;
...
public class MovieListResult extends ListFragment {
    ...
    public MovieListResult(List<Pelicula> p) {
        this.result=p;
    }

    public void setResult(List<Pelicula> result){
        this.result=result;
    }
    @Override
