package com.example.user.w2w.Activities;
...
import com.example.user.w2w.BaseDatos.MyDataSource;

import com.example.user.w2w.Fragments.AboutFragment;
import com.example.user.w2w.Fragments.Configuration;
import com.example.user.w2w.Fragments.MovieListFragment;
import com.example.user.w2w.Fragments.MovieListResult;
import com.example.user.w2w.Fragments.MyListsFragment;
import com.example.user.w2w.Fragments.PopularsFragment;
import com.example.user.w2w.Fragments.SearchMovies;
import com.example.user.w2w.API.ApiRequests;
import com.example.user.w2w.Logica.Lista;
import com.example.user.w2w.Logica.Pelicula;
import com.example.user.w2w.R;
import com.example.user.w2w.ThemeChanger;
